...
def test_teams_in_match():
    ...
    with mock.patch('redis_client.connection', fake_connection):
        # Get the value
        actual = scores_db.scores.teams_in_match(1)
...
def test_teams_disqualified_in_match():
    ...
    with mock.patch('redis_client.connection', fake_connection):
        # Get the value
        actual = scores_db.scores.teams_disqualified_in_match(1)
...
def test_get_match_score():
    ...
    with mock.patch('redis_client.connection', fake_connection):
        # Get the value
        actual = scores_db.scores.get_match_score(1, 'ABC')
...
def test_get_match_scores():
    ...
    with mock.patch('scores_db.scores.teams_in_match', fake_get_teams), \
        ...
        # Get the value
        actual = scores_db.scores.get_match_scores(1)
